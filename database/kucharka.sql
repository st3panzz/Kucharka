...
-- -----------------------------------------------------
-- Table `kucharka`.`propojeni`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kucharka`.`propojeni` ;

CREATE TABLE IF NOT EXISTS `kucharka`.`propojeni` (
  `jidlo_id` INT NOT NULL,
  `ingredience_id` INT NOT NULL,
  `množství` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`jidlo_id`, `ingredience_id`))
ENGINE = InnoDB;
